    ...
    return (
        <div className='flex flex-col my-3 ' >
            ...
            <div className='flex  relative' >
                <input disabled value={props.locaion} className='px-2 py-1 w-full rounded-md' />
                <div className='p-1 absolute right-0 top-0 ' >
                    <Menu as="div" className="relative inline-block text-left -m-1.5">
                        <div>
                            <Menu.Button className="inline-flex w-full justify-center rounded-md bg-black bg-opacity-20 px-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-100">
                                <PencilIcon
