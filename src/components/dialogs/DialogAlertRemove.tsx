              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded bg-white p-6 text-left align-middle shadow-xl transition-all">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    If you remove the "
                    <span className="font-bold">{packageName}</span>" package
                    from your device you will need to install it again. It will
                    be valid that this package does not affect the operation of
                    the system.
                  </p>
                </div>
