    ...
    <div className="px-2  w-full">
      <div className="header flex items-center my-6">
        ...
        <div className="flex flex-col text-slate-600 dark:text-white ">
          ...
          <p className="text-sm ">
            Use AIDB(Android-IOS Debug Bridge) commands GUI, to facilitate the
            development of android and ios applications (React Native).
          </p>
        </div>
      </div>
      <div className="">
        <h5 className="text-md font-medium text-slate-600 dark:text-white my-2">
          Requirements
        </h5>
        <p className="text-sm text-slate-600 dark:text-white mt-2 mb-6 break-words">
          Need Android Debug Bridge for android device (ADB) and XCode for IOS
          device, to get connection with emulator or physical device.
        </p>
                ...
                <Disclosure.Panel className=" px-4 pt-4 pb-2 text-sm text-slate-600 dark:text-white">
                  <ul className="list-decimal">
                    ...
                    <li className="my-2">
                      ...
                      <CodeBlock
                        content="brew install android-platform-tools"
                        showBtnClipboard
              ...
              <>
                ...
                <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-slate-600 dark:text-white">
                  <ul className="list-decimal">
                    ...
                    <li className="my-2">
                      <a href="https://developer.android.com/studio/run/oem-usb#Drivers">
                        Install USB drivers for your device
                      </a>
                    </li>
                    <li className="my-2">
                      <p className="text-slate-500 dark:text-white text-sm mb-1">
              ...
              <>
                ...
                <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-slate-600 dark:text-white">
                  <ul className="list-disc">
                    <li className="my-2">
                      {" "}
                      <p className="mb-1 text-sm">Debian Base:</p>
                      <CodeBlock
                        content="sudo apt install android-sdk-platform-tools"
                        showBtnClipboard
                        copyToClipboard={async (value) =>
                          await writeText(value)
                        }
                    ...
                    <li className="my-2">
                      <p className="mb-1 text-sm">Arch-Linux Base:</p>
                      <CodeBlock
                        content="sudo pacman -S android-tools"
                        showBtnClipboard
                        copyToClipboard={async (value) =>
                          await writeText(value)
                        }
                    ...
                    <li className="my-2">
                      <p className="mb-1 text-sm">Red Hat Base:</p>
                      <CodeBlock
                        content="sudo yum install android-tools"
                        showBtnClipboard
                        copyToClipboard={async (value) =>
                          await writeText(value)
                        }
                    ...
                    <li className="my-2">
                      <p className="mb-1 text-sm">OpenSUSE Base:</p>
                      <CodeBlock
                        content="sudo zypper install android-tools"
                        showBtnClipboard
                        copyToClipboard={async (value) =>
                          await writeText(value)
                        }
