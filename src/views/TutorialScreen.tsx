    ...
    <div className='px-2  w-full' >
      <div className="header flex items-center my-6">
        ...
        <div className='flex flex-col text-slate-600 dark:text-white ' >
          <h4 className='font-medium' >ANDROID ADB GUI</h4>
          <p className='text-sm ' >adb commands GUI, to facilitate the development of android applications (React Native).</p>
        </div>
      </div>
      <div className="">
        ...
        <p className='text-sm text-slate-600 dark:text-white mt-2 mb-6 break-words' >
          Need Android Debug Bridge (ADB) installed to get connection to android device.
        </p>
