...
const CodeBlock: FunctionComponent<Props> = (props) => {
    ...
    return (
        <div className="bg-slate-200 dark:bg-slate-900 rounded w-full px-2 py-1 flex justify-between items-center">
            ...
            {props.showBtnClipboard && <button onClick={() => copyToClipboard(props.content)} className={` p-2 duration-200 transition-all rounded relative w-12 h-12 flex justify-center items-center  ${isSuccessFull ? 'bg-green-400' : ' hover:bg-slate-300 dark:hover:bg-black'}`} >
